  ...
  return (
    ...
    >
      ...
      <div className="mb-1 flex items-center justify-between">
        <span className={`inline-block text-lg font-bold ${headerClass} px-3 py-1 rounded-full`}>
          {title}
        </span>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 px-2 select-none">{description}</p>
